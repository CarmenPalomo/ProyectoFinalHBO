...
class Serie4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imagenCasa: ImageView = findViewById(R.id.imagenCasa14)
        var imagenPerfil : ImageView = findViewById(R.id.imagenPerfil14)
        usuario = intent.getParcelableExtra("Persona")!!

        imagenPerfil.setImageResource(usuario.getImagen())
        video = findViewById(R.id.video14)
        ...
        video!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.the_mentalist))
        video!!.requestFocus()
        video!!.start()
