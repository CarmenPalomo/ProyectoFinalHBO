...
class Serie1Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imagenCasa: ImageView = findViewById(R.id.imagenCasa11)
        var imagenPerfil : ImageView = findViewById(R.id.imagenPerfil11)
        usuario = intent.getParcelableExtra("Persona")!!

        imagenPerfil.setImageResource(usuario.getImagen())
        video = findViewById(R.id.video11)
        ...
        video!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.el_turista))
        video!!.requestFocus()
        video!!.start()
