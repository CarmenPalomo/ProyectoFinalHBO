...
class Imagen2DestacadoActivity : AppCompatActivity() {
    var video : VideoView? = null
    var mediaController : MediaController? = null
    private lateinit var usuario: Usuario
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_imagen2_destacado)

        val imagenCasa: ImageView = findViewById(R.id.imagenCasa2)
        var imagenPerfil : ImageView = findViewById(R.id.imagenPerfil2)
        ...
        video!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.test))
        video!!.requestFocus()
        video!!.start()
