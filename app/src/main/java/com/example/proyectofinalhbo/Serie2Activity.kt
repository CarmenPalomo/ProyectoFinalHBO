...
class Serie2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imagenCasa: ImageView = findViewById(R.id.imagenCasa12)
        var imagenPerfil : ImageView = findViewById(R.id.imagenPerfil12)
        usuario = intent.getParcelableExtra("Persona")!!

        imagenPerfil.setImageResource(usuario.getImagen())
        video = findViewById(R.id.video12)
        ...
        video!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.the_big))
        video!!.requestFocus()
        video!!.start()
