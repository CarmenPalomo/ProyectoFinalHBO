...
class Pelicula5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imagenCasa: ImageView = findViewById(R.id.imagenCasa10)
        var imagenPerfil : ImageView = findViewById(R.id.imagenPerfil10)
        usuario = intent.getParcelableExtra("Persona")!!

        imagenPerfil.setImageResource(usuario.getImagen())
        video = findViewById(R.id.video10)
        ...
        video!!.setVideoURI(Uri.parse("android.resource://" + packageName + "/" + R.raw.interstellar))
        video!!.requestFocus()
        video!!.start()
